# Construction site dust detection dataset 3800 images supports yolo8+voc format.

# Body

The construction site dust detection dataset consists of 3800 images, supporting the formats of Yolo8+VOC. These images were captured from the construction site and labeled with the category "dust," making them suitable for training models for dust detection.
